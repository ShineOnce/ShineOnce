...
package com.axkea.gateway.filter;

import com.alibaba.nacos.client.naming.utils.CollectionUtils;
import com.axkea.gateway.config.Config;
import com.axkea.gateway.tools.JWTUtil;
import com.axkea.gateway.tools.UserInfoDTO;
        ...
        return (exchange, chain) -> {
            ...
            if (isPathInBlackPreList(requestPath, config.getBlackPathPre())) {
                ...
                ServerHttpRequest.Builder builder = exchange.getRequest().mutate().headers(httpHeaders -> {
                    httpHeaders.set("userId", userInfo.getUserId());
                    httpHeaders.set("username", userInfo.getUsername());
